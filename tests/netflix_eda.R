...
ggplot(average_ratings, aes(x = VoteCount, y = AvgRating)) +
  ...
  theme_minimal() +
  labs(title = "Relationship Between Number of Votes and Average Rating", 
       x = "Number of Votes", 
       y = "Average Rating") +
  theme(
...
# (H0): Correlation coefficient (r) = 0, meaning there is no statistically significant relationship between the number of votes and the average rating.
# (H1): Correlation coefficient (r) ??? 0, meaning there is a statistically significant relationship between the number of votes and the average rating.
...
# Therefore, even though there is a relationship between the number of votes and ratings, it is difficult to say that the number of votes has a significant impact on ratings.
